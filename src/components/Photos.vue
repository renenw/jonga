<template>
  <div>
    <Configuration v-if="show.configuration" :settings="photosSettings" :photo-count="photoCount" :filtered-count="filteredCount" v-on:settingsChanged="settingsChanged" />
...
const DEFAULT_SETTINGS = {
  filter: '',
  fileListUrl: 'http://192.168.0.254/files.txt',
  speed: 3000,
  from: 'G:\\Pictures\\',
  to: 'http://192.168.0.254/',
  defaultSettings: true
};
